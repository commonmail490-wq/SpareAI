...
CREATE TABLE IF NOT EXISTS inventory_items (
  ...
  critical_pct DECIMAL(5,4) NOT NULL DEFAULT 0.5000,
  urgent_days INT NOT NULL DEFAULT 7,
  warning_days INT NOT NULL DEFAULT 30,
  overstock_multiplier DECIMAL(5,2) NOT NULL DEFAULT 3.00,
  reorder_qty_factor DECIMAL(5,2) NOT NULL DEFAULT 1.50,
  lead_time_days INT NULL,
  max_stock DECIMAL(10,2) NULL,
  min_order_qty DECIMAL(10,2) NULL,
  alerts_enabled TINYINT(1) NOT NULL DEFAULT 1,
  priority INT NOT NULL DEFAULT 0,
  param_notes VARCHAR(500) NULL,
